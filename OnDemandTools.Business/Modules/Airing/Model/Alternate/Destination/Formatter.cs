...
namespace OnDemandTools.Business.Modules.Airing.Model.Alternate.Destination
{
    public class Formatter
    {
        ...
        protected readonly BLAiringLongModel.Long.Airing Airing;
        ...
        public string Format(string value)
        {
            value = Airing == null
                   ...
                   : value.Replace(AiringId, Airing.AiringId);
            ...
            value = Airing == null
                 ...
                 : value.Replace(Brand, Airing.Brand);
            ...
            value = Airing == null
               ...
               : value.Replace(Episode, FormatEpisodeNumber(Airing.Options.Titles));
        ...
        private string FormatEpisodeNumber(IEnumerable<BLAiringLongModel.Title.Title> titles)
        {
        ...
        private string FormatTitleStorylines(string value)
        {
            ...
            return Regex.Replace(value, TitleStorylinePattern, BuildStorylineFrom(Airing.Options.Titles, type));
        }
        ...
        private string BuildStorylineFrom(IEnumerable<BLAiringLongModel.Title.Title> titles, string type)
        {
