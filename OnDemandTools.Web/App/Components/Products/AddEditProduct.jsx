        ...
        return (
            <Modal bsSize="large" backdrop="static"
                ...
                <Modal.Header closeButton>
                    <Modal.Title>
                        <div>{this.props.data.productDetails.id == null ? "Add Product" : (this.props.permissions.canAddOrEdit ? "Edit Product " : "Product ") + this.state.productUnModifiedData.name}</div>
                    </Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <AddEditProductBasic
