        ...
        return (
            <Modal bsSize="large" className="queueNotificationHistoryModel" onEntering={this.resetGrid.bind(this, this.props.data.queueDetails.name)} show={this.props.data.showNotificationHistoryModel} onHide={this.props.handleClose}>
                <Modal.Header closeButton>
                    <Modal.Title>
                        <div>Notification History for {this.props.data.queueDetails.friendlyName} <InfoOverlay data="The list contains the 50 most recent processed notifications over the last 7 days" placement="right" className="whiteColorText" /> </div>
                    </Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <Form inline>
