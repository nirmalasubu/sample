...
class SessionAlertModal extends React.Component
{
    ...
    render(){
        let minutes="";
        minutes=this.props.data.secondsBeforeSessionEnd>0?this.props.data.secondsBeforeSessionEnd:0;
        return (
           ...
           Warning !
                ...
                <Modal.Body>
           {
                        <p>Your session is about to expire in {minutes} seconds. Do you want to extend the session?</p>
           }
                </Modal.Body>
                <Modal.Footer>
